...
This feature give client an opportunity to fix currency rates for further exchange for 10 minutes.   
For example:   
Your customer want to **receive 100 EUR, sending BTC**. In order to guarantee receiving amount, rates should be fixed. 
...
The **limit** for this operation is **10 000 EUR**.
        ...
        "addresses": [
            {
                ...
                "currency": "BTC",
                "convert_to": "USD",
                "address": "3PG2H3nwb8FXWsB9oof5JiBifLhajqJqfi",
                "tag": null,
                "foreign_id": "frn13"
            }
        ],
        "ts_fixed": 1576743454,
        "ts_release": 1576744054,
        "fix_period": 600,
        "seconds_left": 600,
        "prices": {
            "BTCUSD": {
                "limits": {
                    "0.10000000": "707.67385000",
                    "0.50000000": "3538.25263600",
                    "1.00000000": "7076.42288600",
                    "2.00000000": "14151.73764050",
                    "5.00000000": "35376.68043650",
                    "10.00000000": "70746.88770150"
                },
                "sender_currency": "BTC",
            ...
            "USDBTC": {
                "limits": {
                    "100.00000000": "0.01398867",
                    "500.00000000": "0.06994339",
                    "1000.00000000": "0.13988595",
                    "5000.00000000": "0.69942668",
                    "10000.00000000": "1.39881057",
                    "50000.00000000": "6.99238052",
                    "100000.00000000": "13.98121908"
                },
                "sender_currency": "USD",
...
{% api-method method="post" host="https://app.coinspaid.com/api" path="/futures/confirm" %}
{% api-method-summary %}
...
```
{
    "data": {
        "sender_amount": "0.01",
        "receiver_amount": "70.76738500",
        "fee_amount": "0.70767385",
        "futures_id": 6,
        "sender_currency": "BTC",
        "receiver_currency": "USD",
        "fee_currency": "USD",
