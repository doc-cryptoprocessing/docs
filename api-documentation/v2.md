...
Amount you want to calculate, example: **"3"**
{% endapi-method-parameter %}
{% endapi-method-body-parameters %}
{% endapi-method-request %}
...
{
  "errors": {
    "price": "Fix time is up. Exchange price is changed."
  }
}
```
{% endapi-method-response-example %}
...
{% api-method-description %}
Make exhange without mentioning the price.
{% endapi-method-description %}
    ...
    "transactions": [
        {
            ...
            "transaction_type": "blockchain",
            "type": "deposit",
            "address": "2N8d7Bfd4iwp3yDMTmPTh8FEpWjj19WUMQM",
            "tag": null,
            "amount": "0.01000000",
