...
![Account is credited with the same currency as sent by the customer](../.gitbook/assets/flow1-small.png)
...
![Cryptocurrency withdrawal without exchange](../.gitbook/assets/flow2-small.png)
...
![Cryptocurrency gets converted into Fiat currency, or other crypto.](../.gitbook/assets/flow3-small.png)
...
![Cryptocurrency withdrawal from Fiat currency account](../.gitbook/assets/flow4-small.png)
